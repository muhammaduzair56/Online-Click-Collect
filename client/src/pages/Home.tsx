...
export default function Home() {
  ...
  const [deliveryZone, setDeliveryZone] = useState<"karachi" | "pakistan">("karachi");
  ...
  const deliveryCharge = cartTotal >= 5000 ? 0 : deliveryZone === "karachi" ? 150 : 250;
